...
local objects = {
	["RAW_SEPAM_OLS80_"]="S_ZRU_P11_OLS80_"
}
...
function Command(Name,Suff_Name)	
	if Core[Name[2]..Suff_Name]==true then	--Проверка на то, послали ли команду
		...
		os.sleep(1)							--Делаем паузу, чтобы команда точно дошла
...
local signals = {
	...
	["3216_0_DP"]= {["Comment"]="Неисправность цепей управления ",["eval"]= function(Name) Core[Name[2].."3216_0_DP"]=Core[Name[1].."3216_0_DP"] end},
	["3216_1_DP"]= {["Comment"]="Неисполнение команды управления выключателем ",["eval"]= function(Name) Core[Name[2].."3216_1_DP"]=Core[Name[1].."3216_1_DP"] end},
    ...
    ["3220_0_DP"]= {["Comment"]="Срабатывание токовой отсечки",["eval"]= function(Name) Core[Name[2].."3220_0_DP"]=Core[Name[1].."3220_0_DP"] end},
    ["3220_1_DP"]= {["Comment"]="Срабатывание МТЗ 1 I>> ",["eval"]= function(Name) Core[Name[2].."3220_1_DP"]=Core[Name[1].."3220_1_DP"] end},
    ["3220_2_DP"]= {["Comment"]="Срабатывание МТЗ 2 I> ",["eval"]= function(Name) Core[Name[2].."3220_2_DP"]=Core[Name[1].."3220_2_DP"] end},
    ...
    ["3220_10_DP"]= {["Comment"]="Срабатывание защиты от однофазных замыканий на землю (на сигнал)",["eval"]= function(Name) Core[Name[2].."3220_10_DP"]=Core[Name[1].."3220_10_DP"] end},
    ["3220_11_DP"]= {["Comment"]="Срабатывание защиты от однофазных замыканий на землю (на отключение)",["eval"]= function(Name) Core[Name[2].."3220_11_DP"]=Core[Name[1].."3220_11_DP"] end},

	["3222_2_DP"]= {["Comment"]="Срабатывание направленной защиты от однофазных замыканий на землю (на сигнал)",["eval"]= function(Name) Core[Name[2].."3222_2_DP"]=Core[Name[1].."3222_2_DP"] end},
	["3222_3_DP"]= {["Comment"]="Срабатывание направленной защиты от однофазных замыканий на землю (на отключение) ",["eval"]= function(Name) Core[Name[2].."3222_3_DP"]=Core[Name[1].."3222_3_DP"] end},
    ["3222_15_DP"]= {["Comment"]="Срабатывание УРОВ ",["eval"]= function(Name) Core[Name[2].."3222_15_DP"]=Core[Name[1].."3222_15_DP"] end},

    ["3227_0_DP"]= {["Comment"]="Отключение защитой минимального напряжения ",["eval"]= function(Name) Core[Name[2].."3227_0_DP"]=Core[Name[1].."3227_0_DP"] end},
    ["3227_1_DP"]= {["Comment"]="Отключение от АЧР ",["eval"]= function(Name) Core[Name[2].."3227_1_DP"]=Core[Name[1].."3227_1_DP"] end},
    ...
    ["3227_3_DP"]= {["Comment"]="Выключатель эл. мотора завода пружины привода отключен ",["eval"]= function(Name) Core[Name[2].."3227_3_DP"]=Core[Name[1].."3227_3_DP"] end},
 	["3227_4_DP"]= {["Comment"]="Внешнее отключени",["eval"]= function(Name) Core[Name[2].."3227_4_DP"]=Core[Name[1].."3227_4_DP"] end},
    ["3227_5_DP"]= {["Comment"]="Запрет 2-го цикла АПВ при ОЗЗ на линии ",["eval"]= function(Name) Core[Name[2].."3227_5_DP"]=Core[Name[1].."3227_5_DP"] end},
    ["3227_6_DP"]= {["Comment"]="Срабатывание частотного АПВ ",["eval"]= function(Name) Core[Name[2].."3227_6_DP"]=Core[Name[1].."3227_6_DP"] end},
   
    ["3228_6_DP"]= {["Comment"]="АПВ введено",["eval"]= function(Name) Core[Name[2].."3228_6_DP"]=Core[Name[1].."3228_6_DP"] end},
    ["3228_7_DP"]= {["Comment"]="Готовность АПВ",["eval"]= function(Name) Core[Name[2].."3228_7_DP"]=Core[Name[1].."3228_7_DP"] end},
    ["3228_8_DP"]= {["Comment"]="Неуспешное АПВ",["eval"]= function(Name) Core[Name[2].."3228_8_DP"]=Core[Name[1].."3228_8_DP"] end},
    ["3228_9_DP"]= {["Comment"]="Успешное АПВ",["eval"]= function(Name) Core[Name[2].."3228_9_DP"]=Core[Name[1].."3228_9_DP"] end},
    ["3228_10_DP"]= {["Comment"]="Срабатывание 1-го цикла АПВ",["eval"]= function(Name) Core[Name[2].."3228_10_DP"]=Core[Name[1].."3228_10_DP"] end},
    ["3228_11_DP"]= {["Comment"]="Срабатывание 2-го цикла АПВ ",["eval"]= function(Name) Core[Name[2].."3228_11_DP"]=Core[Name[1].."3228_11_DP"] end},
    ["3228_14_DP"]= {["Comment"]="Включено от АПВ ",["eval"]= function(Name) Core[Name[2].."3228_14_DP"]=Core[Name[1].."3228_14_DP"] end},
	...
	["3229_10_DP"]= {["Comment"]="Литиевая батарея Sepam разряжена ",["eval"]= function(Name) Core[Name[2].."3229_10_DP"]=Core[Name[1].."3229_10_DP"] end},
    ["3229_11_DP"]= {["Comment"]="ЧАПВ введено ",["eval"]= function(Name) Core[Name[2].."3229_11_DP"]=Core[Name[1].."3229_11_DP"] end},
    ...
    ["64012_AP"]= {["Comment"]="Коэффициент мощности ",["eval"]= function(Name) 
																	if Core[Name[1].."64012_AP"]==32767 then
																		Core[Name[2].."64012_AP"]=0
																	else
																		Core[Name[2].."64012_AP"]=Core[Name[1].."64012_AP"]*0.01
																	end
																 end},	
	...
	["818_AP"]= {["Comment"]="Счетчик отключения на землю  ",["eval"]= function(Name) Core[Name[2].."818_AP"]=Core[Name[1].."818_AP"] end},
