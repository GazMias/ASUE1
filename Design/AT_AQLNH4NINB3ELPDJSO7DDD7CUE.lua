while true do	
	if Core['Check_changes_Server1'] == Core['Connect_check_Server1'] then 
		Core['Break_Server1'] = true else 
		Core['Break_Server1'] = false end
	Core['Check_changes_Server1'] = Core['Connect_check_Server1']
